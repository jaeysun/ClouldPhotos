...
import com.jaesun.cloudphotos.base.bridgeModule
                ...
                View {
                    ...
                    View {
                        attr {
                            ...
                            backgroundLinearGradient(Direction.TO_LEFT, ColorStop(Color(0xFF23D3FD), 0f), ColorStop(Color(0xFFAD37FE), 1f))
                        }
                        View {
                            attr {
                    ...
                    event {
                        click {
                            if (ctx.inputText.isEmpty()) {
                                ...
                                getPager().acquireModule<SharedPreferencesModule>(SharedPreferencesModule.MODULE_NAME).setItem(
                ...
                View {
                    ...
                    Text {
                        attr {
                            ...
                            fontSize(17f)
                            fontWeightSemisolid()
                            backgroundLinearGradient(Direction.TO_BOTTOM, ColorStop(Color(0xFF23D3FD), 0f), ColorStop(Color(0xFFAD37FE), 1f))
